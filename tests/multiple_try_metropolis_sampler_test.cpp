...
#include <mcmc/samplers/multiple_try_metropolis_sampler.hpp>

TEST_CASE("Multiple-Try Metropolis sampler is tested.", "[mcmc::multiple_try_metropolis_sampler]")
{
  ...
  mcmc::multiple_try_metropolis_sampler<float, Eigen::VectorXf, Eigen::MatrixXf, std::normal_distribution<float>> sampler(
