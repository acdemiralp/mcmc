...
#include <mcmc/samplers/adaptive_metropolis_sampler.hpp>

TEST_CASE("Adaptive Metropolis sampler is tested.", "[mcmc::adaptive_metropolis_sampler]")
{
  ...
  mcmc::adaptive_metropolis_sampler<float, Eigen::VectorXf, Eigen::MatrixXf, std::normal_distribution<float>> sampler(
